...
public class RegisterEvents {
    ...
    static void entityAttributes(EntityAttributeCreationEvent event) {
        ...
        event.put(ModEntities.Grass.get(), PlantLikeEntity.createAttributes().build());
        ...
        event.put(ModEntities.IchorGolemEntity.get(), BaseSlimeGolemEntity.createAttributes().build());

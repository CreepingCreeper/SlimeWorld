...
public class ModItemTagProvider extends ItemTagProvider {
    ...
    protected void addTags(@NotNull HolderLookup.Provider lookupProvider) {
        ...
        tag(ModTags.Items.ARCHETYPE_FAST_SLIDING).add(Items.BLUE_ICE).add(Items.PACKED_ICE).add(Items.SNOW_BLOCK);
        tag(ModTags.Items.ARCHETYPE_HIGH_RESISTANCE).add(Items.SOUL_SAND).add(Items.SOUL_SOIL);
        tag(ModTags.Items.ARCHETYPE_LIGHT).addTag(ItemTags.WOOL);
        tag(ModTags.Items.ARCHETYPE_REGULAR)
                .add(Items.WHITE_CONCRETE_POWDER).add(Items.ORANGE_CONCRETE_POWDER).add(Items.MAGENTA_CONCRETE_POWDER).add(Items.LIGHT_BLUE_CONCRETE_POWDER).add(Items.YELLOW_CONCRETE_POWDER)
                ...
                .add(Items.PODZOL).add(Items.GRASS_BLOCK).add(Items.CLAY).add(Items.BONE_BLOCK);
        tag(ModTags.Items.ARCHETYPE_SLOW_FLAT)
                .add(Items.IRON_BLOCK).add(Items.GOLD_BLOCK).add(Items.RAW_COPPER_BLOCK).add(Items.RAW_GOLD_BLOCK).add(Items.RAW_IRON_BLOCK)
        ...
        tag(ModTags.Items.ARCHETYPE_SLOW_BOUNCY)
                .add(Items.AMETHYST_BLOCK).add(Items.ANDESITE).add(Items.BASALT).add(Items.BLACKSTONE).add(Items.BRICKS)
        ...
        tag(ModTags.Items.ARCHETYPE_SLOW_SLIDING)
        ...
        tag(ModTags.Items.ARCHETYPE_STICKY)
                .add(Items.HONEYCOMB_BLOCK);
        tag(ModTags.Items.ARCHETYPE_EXPLOSIVE)
                .add(Items.TNT);
        tag(ModTags.Items.ARCHETYPE_HOT)

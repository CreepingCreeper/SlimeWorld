...
public class ModEntityLootTableProvider extends EntityLootSubProvider {
    ...
    public void generate() {
        this.add(ModEntities.SLlama.get(), LootTable.lootTable());
        this.add(ModEntities.Grass.get(), LootTable.lootTable());


        this.add(ModEntities.BoggedEntity.get(), LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.BONE).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.TIPPED_ARROW).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 1.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F)).setLimit(1)).apply(SetPotionFunction.setPotion(Potions.POISON))).when(LootItemKilledByPlayerCondition.killedByPlayer())));
        this.add(ModEntities.ParchedEntity.get(), LootTable.lootTable().withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.ARROW).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.BONE).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 2.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F))))).withPool(LootPool.lootPool().setRolls(ConstantValue.exactly(1.0F)).add(LootItem.lootTableItem(Items.TIPPED_ARROW).apply(SetItemCountFunction.setCount(UniformGenerator.between(0.0F, 1.0F))).apply(LootingEnchantFunction.lootingMultiplier(UniformGenerator.between(0.0F, 1.0F)).setLimit(1)).apply(SetPotionFunction.setPotion(Potions.WEAKNESS))).when(LootItemKilledByPlayerCondition.killedByPlayer())));

        this.add(ModEntities.OceanSlimeEntity.get(), dropSlimeballs(ModItems.OceanSlimeBall.get(), ModItems.BronzeShard.get()));
        this.add(ModEntities.OriginSlimeEntity.get(), LootTable.lootTable());
        this.add(ModEntities.IchorSlimeEntity.get(), dropSlimeballs(TinkerCommons.slimeball.get(SlimeType.ICHOR), TinkerWorld.cobaltShard.get()));
        this.add(ModEntities.SulfurCubeEntity.get(), dropSlimeballs(ModItems.SulfurGoo.get(), null));
        this.add(ModEntities.TomatoSlimeEntity.get(), dropSlimeballs(ModItems.TomatoPudding.get(), null));

        this.add(ModEntities.EarthSlimeGolemEntity.get(), LootTable.lootTable());
        this.add(ModEntities.SkySlimeGolemEntity.get(), LootTable.lootTable());
        this.add(ModEntities.OceanSlimeGolemEntity.get(), LootTable.lootTable());
        this.add(ModEntities.IchorSlimeGolemEntity.get(), LootTable.lootTable());
        this.add(ModEntities.EnderSlimeGolemEntity.get(), LootTable.lootTable());

        this.add(ModEntities.SteelSlimeBossEntity.get(), LootTable.lootTable());
        this.add(ModEntities.KnightSlimeBossEntity.get(), LootTable.lootTable());
    }
